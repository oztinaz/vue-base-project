import VTooltipBalloon from '@/components/v-tooltip/v-tooltip-balloon/VTooltipBalloon.vue'
import { beforeEach, describe, expect, test } from 'vitest'
import { VueWrapper, mount } from '@vue/test-utils'

describe('@/components/v-tooltip/v-tooltip-balloon/VTooltipBalloon', () => {
  let wrapper: VueWrapper

  beforeEach(() => {
    wrapper = mount(VTooltipBalloon, {
      props: {
        attribute: 'height',
        isPositive: true,
        isVertical: false,
