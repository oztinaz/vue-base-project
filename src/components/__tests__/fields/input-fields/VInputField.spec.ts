import VInputField from "@/components/fields/input-fields/VInputField.vue"
...
describe('@/components/fields/input-fields/VInputField.vue', () => {
  ...
  test('inputClassName is input-field when isValidationEnabled is false', () => {
    expect(inputClass.value).toBe('input-field')
  })
  ...
  test('displays slot', () => {
    const field = wrapper.get('[data-test="field"]')
